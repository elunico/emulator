...
struct cpu_breaker {
  ...
  [[nodiscard]] u32 fetch(u32 const& addr) const;

  fetch_result get_next_instruction();
  ...
  [[nodiscard]] u32 const& a() const;
  [[nodiscard]] u32 const& b() const;
  [[nodiscard]] u32 const& x() const;

  [[nodiscard]] f64 const& fa() const;
  [[nodiscard]] f64 const& fb() const;
  [[nodiscard]] f64 const& fx() const;

  [[nodiscard]] u32 const& ctrl() const;

  [[nodiscard]] u32 const& sp() const;

  [[nodiscard]] u32 const& ra() const;

  [[nodiscard]] u32 const& pc() const;

  [[nodiscard]] auto const& ram() const;
